...
#ifndef soapudpObject_H
#define soapudpObject_H
#include "soapH.h"
...
SOAP_FMAC5 int SOAP_FMAC6 ns__echoString(struct soap*, char *str, char **res);

SOAP_FMAC5 int SOAP_FMAC6 ns__sendString(struct soap*, char *str);
