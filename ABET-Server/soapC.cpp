...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.16 2013-08-27 05:55:33 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	case SOAP_TYPE_ns__sendString:
		return soap_in_ns__sendString(soap, NULL, NULL, "ns:sendString");
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns:sendString"))
		{	*type = SOAP_TYPE_ns__sendString;
			return soap_in_ns__sendString(soap, NULL, NULL, NULL);
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
{
	...
	case SOAP_TYPE_ns__sendString:
		return soap_out_ns__sendString(soap, tag, id, (const struct ns__sendString *)ptr, "ns:sendString");
	case SOAP_TYPE_ns__echoString:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	{
	case SOAP_TYPE_ns__sendString:
		soap_serialize_ns__sendString(soap, (const struct ns__sendString *)ptr);
		break;
	case SOAP_TYPE_ns__echoString:
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_instantiate(struct soap *soap, int t, const char *type, const char *arrayType, size_t *n)
{
	...
	case SOAP_TYPE_ns__sendString:
		return (void*)soap_instantiate_ns__sendString(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns__sendString:
		if (p->size < 0)
			SOAP_DELETE((struct ns__sendString*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct ns__sendString*)p->ptr);
		break;
	case SOAP_TYPE_SOAP_ENV__Code:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__sendString(struct soap *soap, struct ns__sendString *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_string(soap, &a->str);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__sendString(struct soap *soap, const struct ns__sendString *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_string(soap, &a->str);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__sendString(struct soap *soap, const char *tag, int id, const struct ns__sendString *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__sendString), type))
		return soap->error;
...
SOAP_FMAC3 struct ns__sendString * SOAP_FMAC4 soap_in_ns__sendString(struct soap *soap, const char *tag, struct ns__sendString *a, const char *type)
{
	size_t soap_flag_str = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__sendString *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__sendString, sizeof(struct ns__sendString), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__sendString(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__sendString *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__sendString, 0, sizeof(struct ns__sendString), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__sendString(struct soap *soap, const struct ns__sendString *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__sendString);
	if (soap_out_ns__sendString(soap, tag?tag:"ns:sendString", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns__sendString * SOAP_FMAC4 soap_get_ns__sendString(struct soap *soap, struct ns__sendString *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__sendString(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct ns__sendString * SOAP_FMAC2 soap_instantiate_ns__sendString(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__sendString(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__sendString, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct ns__sendString);
		if (size)
			*size = sizeof(struct ns__sendString);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct ns__sendString[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct ns__sendString);
	}
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct ns__sendString*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__sendString(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct ns__sendString %p -> %p\n", q, p));
	*(struct ns__sendString*)p = *(struct ns__sendString*)q;
}
